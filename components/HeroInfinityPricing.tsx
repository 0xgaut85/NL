...
export default function HeroInfinityPricing(){
  return (
    <div className="relative w-full h-[60vh] md:h-[75vh] lg:h-[85vh] overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 grid place-items-center pointer-events-none">
        <div className="text-center px-4 md:px-6 flex flex-col items-center max-w-5xl">
          <motion.h1 
            className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 text-[#2d5a3d] pointer-events-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            <span className="font-mono bracket-text">Transparent Pricing</span>
          </motion.h1>
          <motion.p 
            className="text-xl md:text-2xl lg:text-3xl text-black mb-6 max-w-3xl mx-auto leading-relaxed pointer-events-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4, duration: 0.6 }}
          >
            No hidden fees. No surprises. Just unrestricted AI at predictable costs.
          </motion.p>
          <motion.p 
            className="text-base md:text-lg lg:text-xl text-black/60 max-w-2xl mx-auto pointer-events-auto"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6, duration: 0.6 }}
          >
            All plans include zero content filters and complete API access
          </motion.p>
        </div>
      </div>
    </div>
